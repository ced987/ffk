...
@section('title', 'Ajouter un licencié - FFK Interclubs')
@section('page-title', 'Ajouter un licencié')
...
<main>
        ...
        <section>
            <form method="POST" action="{{ route('licencies.store') }}">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div>
                        ...
                        <input id="poids" name="poids" type="number" min="1" step="1" value="{{ old('poids') }}" required>
                        @error('poids')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
