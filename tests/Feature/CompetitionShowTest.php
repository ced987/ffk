...
class CompetitionShowTest extends TestCase
{
    ...
    public function test_competition_detail_shows_invited_clubs_summary_with_readable_statuses(): void
    {
        ...
        $this->withSession(['current_user_id' => $userA->id])
            ...
            ->assertSee("'#actions': 'suivi'", false)
            ->assertSee("'#invitation': 'clubs'", false)
            ->assertSee("'#participants': 'participants'", false)
            ->assertSee("'#poules': 'poules'", false)
            ->assertSee('Préparation de l’invitation')
            ->assertSee('En attente')
            ->assertSee('Confirmés')
            ->assertSee('Refusés')
            ->assertSee('En attente de réponse')
            ->assertSee('Participation confirmée')
            ->assertSee('Participation refusée')
            ->assertSee('Club B')
            ->assertSee('Club C')
            ->assertSee('Club D')
            ->assertSee('Club E');
